...
parltweet=get_timeline(parlamento$Twitter, n=1, token = tokenb, check = FALSE)
...
#freqpoly
ggplot(parltweet, aes(as.POSIXct(created_at,"%Y-%m-%d %H:%M:%S")))+geom_freqpoly(binwidth=60*60, color="black")  
...
tutto
saveWidget(tutto,"tutto.html", selfcontained = FALSE)


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
