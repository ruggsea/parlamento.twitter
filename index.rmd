...
app <- rtweet_app(api_key = api_key, api_secret = api_secret_key, access_token = access_token, access_secret= access_token_secret)
auth_as(app)

parlamento=read_csv("parlamento.csv") %>% 
    drop_na(Twitter)
parltweet=get_timeline(parlamento$Twitter, n=50, retryonratelimit = TRUE)
